...
public class Board {
	...
	public Board(String boardNo, String memberNo, String boardWriter, int boardType, String boardTypeNm,
			...
			int boardDislike, Member member, ArrayList<BoardFile> fileList, ArrayList<BoardComment> commentList) {
		super();
	...
	public String toString() {
		return "Board [boardNo=" + boardNo + ", memberNo=" + memberNo + ", boardWriter=" + boardWriter + ", boardType="
				...
				+ ", boardDislike=" + boardDislike + ", member=" + member + ", fileList=" + fileList + ", commentList="
				+ commentList + "]";
	}
}
